...
//прописывать opacity для каждого куска при hover'e
//баг если один из кусков (не первый) больше 50%
//градиенты для всех браузеров - как вписать (styles.addRule)
//м.б. прописывать все свойства через styles.addRule ?
//для кусков больше 50% - разбивать на куски 50% и оставшиеся проценты и заливать одним цветом
